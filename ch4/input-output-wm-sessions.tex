...
\TriggersMulti{
  ...
  \sumA{\TriggersInline{#2}{a
	...
	%%%%
 	...
 	\DrawIn{#2}{0.333}{0.833}{\DrawStatex{0.444}{1.444}{0.000}{#2}{1.0}{1.444}}
	
	\DrawIn{#2}{0.666}{2.110}{\DrawStatex{2.444}{3.444}{0.000}{#2}{1.0}{3.444}}
	\DrawIn{#2}{1.222}{1.665}{\DrawStatex{3.666}{4.666}{0.000}{#2}{1.0}{4.666}}
	\DrawIn{#2}{1.666}{2.110}{\DrawStatex{3.666}{5.333}{0.000}{#2}{1.7}{5.333}}
	\DrawIn{#2}{2.111}{2.600}{\DrawStatex{2.444}{5.333}{0.000}{#2}{2.9}{5.333}}
	
	\DrawIn{#2}{2.333}{3.665}{\DrawStatex{6.666}{7.666}{0.000}{#2}{1.0}{7.666}}
	\DrawIn{#2}{3.666}{3.999}{\DrawStatex{6.666}{8.444}{0.000}{#2}{1.8}{8.444}}
	\DrawIn{#2}{4.000}{4.350}{\DrawStatex{6.666}{8.777}{0.000}{#2}{2.1}{8.777}}
	
	\DrawAt{#2}{0.833}{
		\DrawOutput{0.444}{1.4444}{0.000}{0.833}{}
		\DrawInput{black}{1.444}{0.833}{1.0}{c_watermark_e}
	}

	\DrawAt{#2}{2.6}{
		\DrawOutput{2.444}{5.333}{0.000}{2.6}{}
		\DrawInput{black}{5.333}{2.6}{2.9}{c_watermark_e}
	}

	\DrawAt{#2}{4.35}{
		\DrawOutput{6.666}{8.7777}{0.000}{4.35}{}
		\DrawInput{black}{8.777}{4.35}{2.1}{c_watermark_e}
	}
  }}
  \sumB{\TriggersInline{#2}{
	...
	\DrawIn{#2}{0.777}{1.332}{\DrawStatex{0.666}{1.666}{0.000}{#2}{1.0}{1.666}}	
	\DrawIn{#2}{1.333}{1.85}{\DrawStatex{0.666}{2.222}{0.000}{#2}{1.6}{2.222}}	
	
	\DrawIn{#2}{1.666}{3.15}{\DrawStatex{2.666}{3.666}{0.000}{#2}{1.0}{3.666}}
	
	\DrawIn{#2}{2.888}{3.25}{\DrawStatex{3.888}{4.888}{0.000}{#2}{1.0}{4.888}}
	
	\DrawIn{#2}{2.0}{2.110}{\DrawStatex{6.666}{7.666}{0.000}{#2}{1.0}{7.666}}
	\DrawIn{#2}{2.111}{2.554}{\DrawStatex{5.888}{7.666}{0.000}{#2}{1.8}{7.666}}
	\DrawIn{#2}{2.555}{3.55}{\DrawStatex{5.888}{7.666}{0.000}{#2}{1.8}{7.666}}
	
	\DrawIn{#2}{3.222}{4.0}{\DrawStatex{7.777}{8.777}{0.000}{#2}{1.0}{8.777}}
	...
	\DrawAt{#2}{1.85}{
		\DrawInput{black}{2.222}{1.85}{1.6}{c_watermark_f}
	}
	
	% For 2nd plot (Tyler) draw resulting final session lengths
	
	\DrawAt{#2}{3.15}{
		\DrawInput{black}{3.666}{3.15}{1.0}{c_watermark_f}
	}
	
	\DrawAt{#2}{3.25}{
		\DrawInput{black}{4.888}{3.25}{1.0}{c_watermark_f}
	}
	
	\DrawAt{#2}{3.55}{
		\DrawInput{black}{7.666}{3.55}{1.8}{c_watermark_f}
	}
	
	\DrawAt{#2}{4.0}{
		\DrawInput{black}{8.777}{4.0}{1.0}{c_watermark_f}
	}
  ...
  \topp{\TriggersInline{#2}{
	...
	\DrawIn{#2}{0.777}{1.8}{\DrawStatex{0}{2}{0.000}{#2}{1.0}{1.8}}	
		...
		\DrawMarkedOutput{1.8}{1.8}{1.8}{3.5}{1.0}{#2}
	}

	\DrawIn{#2}{1.9}{3.000}{\DrawStatex{2}{4}{0.000}{#2}{1.6}{3.8}}	
	\DrawIn{#2}{3.001}{3.255}{\DrawStatex{2}{4}{0.000}{#2}{1.3}{3.8}}	
    	\DrawAt{#2}{3.255}{
	    	\DrawOutput{2}{4}{0.000}{3.255}{}
		\DrawMarkedOutput{3.8}{3.255}{3.8}{4.4}{1.3}{#2}
	}
	...
	\DrawIn{#2}{3.25}{3.333}{\DrawStatex{4}{6}{0.000}{#2}{2.0}{5.8}}	
		...
		\DrawMarkedOutput{5.8}{3.333}{5.8}{4.5}{2.0}{#2}
	}

	\DrawIn{#2}{3.666}{4.333}{\DrawStatex{6}{8}{0.000}{#2}{1.8}{7.8}}	
    	\DrawAt{#2}{4.37}{
		\DrawOutput{6}{8}{0.000}{4.37}{}
		\DrawMarkedOutput{7.8}{4.37}{7.8}{5.2}{1.8}{#2}
	}
