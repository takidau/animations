...
\newcommand {\DrawInputsG}[4] {
	\def \InputStyle{3}
	\DrawInput{#1}{0.444}{0.833}{1.0}{#3} % A
	\DrawInput{#1}{2.444}{2.600}{2.9}{#3} % A
	\DrawInput{#1}{6.666}{4.350}{2.1}{#3} % A
	%\DrawInput{#1}{6.666}{4.37}{12}{#3} % A
	\def \InputStyle{2}
	\DrawInput{#2}{0.666}{1.850}{1.6}{#4} % B
	\DrawInput{#2}{2.666}{3.150}{1.0}{#4} % B
	\DrawInput{#2}{3.888}{3.250}{1.0}{#4} % B
	\DrawInput{#2}{5.888}{3.550}{1.8}{#4} % B
	\DrawInput{#2}{7.777}{4.000}{1.0}{#4} % B
}
...
\newcommand{\DrawOutputWatermarkE}[2] {
	...
	;
	\draw [#1, #2] (\ox + 0.444, \oy + 0.666) -- (\ox + 0.444, \oy + 0.833);
	\draw [#1, #2] (\ox + 0.444, \oy + 0.800) -- (\ox + 1.444, \oy + 0.833);
	\draw [-, #1, #2] 
		(\ox + 1.444, \oy + 0.833)
		to [out=10,in=180] (\ox + 2.444, \oy +  1.00) % 7
	;
	\draw [#1, #2] (\ox + 2.444, \oy + 1.000) -- (\ox + 2.444, \oy + 2.600);
	\draw [#1, #2] (\ox + 2.444, \oy + 2.600) -- (\ox + 5.333, \oy + 2.600);
	...
	\draw [-, #1, #2] 
		(\ox + 5.333, \oy + 2.655)
		to [out=0,in=180] (\ox + 6.666, \oy +  2.700) % 7
	;
	\draw [#1, #2] (\ox + 6.666, \oy + 2.700) -- (\ox + 6.666, \oy + 4.350);
	\draw [#1, #2] (\ox + 6.666, \oy + 4.350) -- (\ox + 8.000, \oy + 4.350);
...
\newcommand{\DrawOutputWatermarkF}[2] {
	\draw [-, #1, #2] 
		...
		%to [out=80,in=180] (\ox + 1.444, \oy +  1.666) % 9
	;
	\draw [#1, #2] (\ox + 0.666, \oy + 1.333) -- (\ox + 0.666, \oy + 1.850);
	\draw [#1, #2] (\ox + 0.666, \oy + 1.850) -- (\ox + 2.000, \oy + 1.850);	
	\draw [-, #1, #2] 
		(\ox + 2.000, \oy + 1.850)
		to [out=22, in=198] (\ox + 2.666, \oy +  2.043) % 1
		%to [out=0, in=180] (\ox + 3.111, \oy +  2.111) % 8
	;	
	\draw [#1, #2] (\ox + 2.666, \oy + 2.043) -- (\ox + 2.666, \oy + 3.150);	
	\draw [#1, #2] (\ox + 2.666, \oy + 3.150) -- (\ox + 4.000, \oy + 3.150);	
	\draw [-, #1, #2] 
		(\ox + 4.000, \oy + 3.223)
		to [out=0, in=183] (\ox + 5.888, \oy +  3.293) % 3
	;	
	\draw [#1, #2] (\ox + 5.888, \oy + 3.293) -- (\ox + 5.888, \oy + 3.550);	
	\draw [#1, #2] (\ox + 5.888, \oy + 3.550) -- (\ox + 6.000, \oy + 3.550);	
	%\draw [-, #1, #2] 
	%	(\ox + 6.000, \oy + 3.550)
	%	to [out=0, in=183] (\ox + 6.222, \oy +  3.308) % 3
	%;	
	\draw [#1, #2] (\ox + 6.00, \oy + 3.550) -- (\ox + 7.666, \oy + 3.550);	
        \draw [-, #1, #2] 
		(\ox + 7.666, \oy + 3.550)
		to [out=0, in=183] (\ox + 7.777, \oy +  3.585) % 3
	;	
	\draw [#1, #2] (\ox + 7.777, \oy + 3.585) -- (\ox + 7.777, \oy + 4.000);	
	\draw [#1, #2] (\ox + 7.777, \oy + 4.000) -- (\ox + 8.777, \oy + 4.000);	
	%\draw [-, #1, #2] 
	%	(\ox + 8.000, \oy + 3.585)
...
\draw [-, #1, #2] 
	...
	\draw [-, #1, #2] 
		(\ox + 2.000, \oy + 1.850)
		to [out=22, in=198] (\ox + 2.444, \oy +  1.963) % 1
		%to [out=0, in=180] (\ox + 3.111, \oy +  2.111) % 8
	;	
	\draw [#1, #2] (\ox + 2.444, \oy + 1.963) -- (\ox + 2.444, \oy + 2.600);	
	\draw [#1, #2] (\ox + 2.444, \oy + 2.600) -- (\ox + 2.666, \oy + 2.600);	
	\draw [#1, #2] (\ox + 2.666, \oy + 2.600) -- (\ox + 2.666, \oy + 3.150);	
	\draw [#1, #2] (\ox + 2.666, \oy + 3.150) -- (\ox + 4.000, \oy + 3.150);	
	\draw [-, #1, #2] 
		(\ox + 4.000, \oy + 3.223)
		to [out=0, in=183] (\ox + 5.888, \oy +  3.293) % 3
	...
	%	to [out=0, in=183] (\ox + 6.222, \oy +  3.308) % 3
	%;	
	\draw [#1, #2] (\ox + 6.00, \oy + 3.550) -- (\ox + 6.666, \oy + 3.550);	
	\draw [#1, #2] (\ox + 6.666, \oy + 3.550) -- (\ox + 6.666, \oy + 4.350);	
	\draw [#1, #2] (\ox + 6.666, \oy + 4.350) -- (\ox + 8.000, \oy + 4.350);	
        \draw [-, #1, #2] 
		(\ox + 8.000, \oy + 4.350)
		to [out=0, in=183] (\ox + 9, \oy +  4.37) % 3
	;	
	%\draw [#1, #2] (\ox + 7.777, \oy + 3.585) -- (\ox + 7.777, \oy + 4.000);	
	%\draw [#1, #2] (\ox + 7.777, \oy + 4.000) -- (\ox + 8.777, \oy + 4.000);	
}
