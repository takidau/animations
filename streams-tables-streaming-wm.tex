...
\TriggersMulti{
	...
	\StreamInline{
		\DrawWatermarkA
		\DrawInputsA{c_datum_border}{c_datum_text}{c_datum_border}
	}
	...
	\StreamInline{
		...
		\DrawIn{\stYoff}{2.500}{12.0}{\DrawOutput{2}{4}{2.000}{2.500}{18}}
		\DrawIn{\stYoff}{2.675}{12.0}{\DrawOutput{4}{6}{2.175}{2.675}{4}}
...
\newcommand{\FastFrames}{0,...,40}%0,8,23,75,96}
