...
\newcommand {\DrawInputOld}[5] {
	\definecolor{c_shadex}{HTML}{333333} % non-ghost background only
	\filldraw[#1, draw=#5,fill=c_shadex] (\ox + #2, \oy + #3) circle [radius=6pt];
	\definecolor{c_shade}{HTML}{000000} % non-ghost/red 000000 ghost AAAAAA 
	%\node[#5,font=\bf\sffamily] at (\ox + #2, \oy + #3) {\contour{c_shade}{#4}};
