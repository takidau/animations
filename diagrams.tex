...
\newcommand {\DrawInputsA}[3][0] {
	...
	\DrawInput{#2}{3.111}{2.111 + #1 + \InputsAEightBump}{8}{#3}
	\DrawInput{#2}{3.666}{1.222 + #1}{3}{#3}
	%\DrawInput{#2}{3.888}{1.444 + #1}{4}{#3}
	\DrawInput{#2}{4.333}{1.666 + #1 + \InputsAFourBump}{4}{#3}. % used to be 3
	\DrawInput{#2}{6.666}{2.333 + #1}{3}{#3}
	\DrawInput{#2}{7.444}{3.666 + #1 - \InputsAEightBump}{8}{#3}
